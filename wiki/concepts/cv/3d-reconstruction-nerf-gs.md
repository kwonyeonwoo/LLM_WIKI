...
- **동적 확장(2024~)**: deformable/4D Gaussian Splatting이 canonical space + deformation field로 동적 장면을 실시간 렌더 → "정적 장면 한정" 한계 완화.
- **Physical AI 연결**: 3D scene 복원 → 로봇 grasping·manipulation, 시뮬레이션 자산 생성에 활용. 3DGS-in-Robotics survey가 자율주행·scene understanding 응용 정리.
...
- Survey on 3DGS — https://arxiv.org/abs/2401.03890
- 3DGS in Robotics — https://arxiv.org/abs/2410.12262

## Conflicts / Open Questions

- 동적/반사/투명 표면은 deformable·4D Gaussian으로 일부 해결되나 여전히 활성 연구 → 표준 벤치마크 미정.
